<tr>
    ...
    <td class="px-10 py-4 whitespace-nowrap">
        <span class="inline-flex -space-x-px overflow-hidden bg-white border rounded-md shadow-sm dark:border-gray-800 dark:bg-gray-700">
            <a href="{{ route('user.show', $user->id) }}" wire:navigate class="inline-block px-4 py-2 text-sm font-medium text-blue-700 hover:bg-blue-50 focus:relative dark:text-blue-500 dark:hover:bg-blue-900 dark:hover:text-blue-100">
                View
            </a>
